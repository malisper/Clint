...
(deftest and (logic-macros)
  (assert-true   (eval-string "(and)"))
  (assert-false  (eval-string "(and '())"))
  (assert-eql 10 (eval-string "(and 10)"))
  (assert-eql 5  (eval-string "(and 10 5)"))
  (assert-false  (eval-string "(and '() 10)"))
  (assert-false  (eval-string "(and 10 '())"))
  (assert-false  (eval-string "(and '() '())")))
...
(deftest or (logic-macros)
  ...
  (assert-false  (eval-string "(or '())"))
  (assert-eql 5  (eval-string "(or 5 10)"))
